...
/**
 * Suite de pruebas para DAOImpl.updatePersonMobile()
 * Valida la actualización de número de celular de personas físicas.
 */
@DisplayName("Suite de pruebas de DAOImpl.updatePersonMobile():")
class UpdatePersonMobileTest extends DAOUpdateTest {

    @InjectMocks
    private DAOImpl daoImpl;

    private static final String ERROR_MESSAGE = "Error al actualizar el celular de la persona";
    ...
    public String getSqlStatement() {
        return SQLStatements.UPDATE_PERSON_MOBILE;
    }
    ...
    @DisplayName("Debe actualizar el celular de la persona correctamente con diferentes variaciones de número")
    void updatePersonMobile_givenValidMobileVariations_updatesSuccessfully(
            String mobileToTest,
            String displayDescription) throws Exception {

        setupSuccessfulUpdate(SINGLE_ROW_UPDATED);

        assertDoesNotThrow(() -> daoImpl.updatePersonMobile(nonBusinessDatatype, mobileToTest));
    ...
    void updatePersonMobile_givenSQLExceptionAtDifferentPoints_throwsServiceException(
        ...
        ServiceException exception = assertThrows(ServiceException.class,
                () -> daoImpl.updatePersonMobile(nonBusinessDatatype, MOBILE_VALID));
    ...
    void updatePersonMobile_givenException_closesResourcesCorrectly() throws Exception {
    ...
    void updatePersonMobile_givenNoRowsAffected_executesWithoutError() throws Exception {
        setupSuccessfulUpdate(ZERO_ROWS_UPDATED);

        assertDoesNotThrow(() -> daoImpl.updatePersonMobile(nonBusinessDatatype, MOBILE_VALID));
